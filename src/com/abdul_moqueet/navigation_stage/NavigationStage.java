package com.abdul_moqueet.navigation_stage;
...
import com.abdul_moqueet.my_utils.CallBack;
...
public class NavigationStage implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        setChildInBorderPane(0, "/com/abdul_moqueet/dash_board/dash_board.fxml");

        nav_btn_dash_board.setOnMouseClicked(e->
                setChildInBorderPane(0, "/com/abdul_moqueet/dash_board/dash_board.fxml"));

        nav_btn_take_admission.setOnMouseClicked(e->
            setChildInBorderPane(1, "/com/abdul_moqueet/take_admission/take_admission.fxml"));

        nav_btn_student_info.setOnMouseClicked(e ->
                setChildInBorderPane(2, "/com/abdul_moqueet/student_info/student_info.fxml"));

        nav_btn_payment.setOnMouseClicked(e->
                setChildInBorderPane(3, "/com/abdul_moqueet/payment_info/payment_info.fxml"));

        nav_btn_setting.setOnMouseClicked(e->
                setChildInBorderPane(4, "/com/abdul_moqueet/setting/setting.fxml"));
        ...
        nav_btn_signOut.setOnMouseClicked(e->
                MyAlert.confirmAlert(getClass(), "Are you sure u wanna signOut?",()->{
                    ...
                    try {
                        ...
                        Parent root = FXMLLoader.load(getClass().getResource("/com/abdul_moqueet/splash_login/login.fxml"));
