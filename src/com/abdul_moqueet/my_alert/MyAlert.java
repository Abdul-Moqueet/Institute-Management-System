...
public class MyAlert {
    ...
    public static void okayAlert(Class context, String text) {
        ...
        OkayAlert controller = alertStage(context, "/com/abdul_moqueet/my_alert/ok.fxml").getController();
    ...
    public static ConfirmAlert confirmAlert(Class context, String text, CallBack callBack) {
        ...
        ConfirmAlert controller = alertStage(context, "/com/abdul_moqueet/my_alert/confirm.fxml").getController();
